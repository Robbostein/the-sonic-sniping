...
wallet = Web3.toChecksumAddress('')
private_key = ""

amounts = Web3.toWei(2, unit='ether')
gasAmount = int(3500000)
gasPrice = Web3.toWei(2500, unit='gwei')
slippage = int(49.99)
...
if web3.isConnected():
  print(style.YELLOW+"Web3 is connected | FANTOM OPERA\n"+style.RESET)
  print("")

balance_account = web3.eth.get_balance(wallet)/ 10**18

print(style.YELLOW+"Connected wallet address {}".format(wallet[:15]) +"...\nBal: {:.4f}".format(balance_account)+ " FTM | Amount: {:.4f}".format(amounts/10**18)+" FTM | Slip: {}".format(slippage)+"% "+style.RESET)
print("")
print("")
...
while True:
  try:
    ...
    if pair == '0x0000000000000000000000000000000000000000':
      ...
      delete_last_line()
    elif pair != "0x0000000000000000000000000000000000000000" and balPair > 0.1:
      buy_token()
      break
      ...
      print_slow(style.MAGENTA+"~ Insuciffient Liquidity for ${}".format(symbol)+"/WFTM pair address!!\n"+style.RESET)
      delete_last_line()
